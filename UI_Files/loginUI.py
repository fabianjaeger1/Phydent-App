...
class Ui_login(object):
    def setupUi(self, login):
        ...
        self.remember_me.setStyleSheet("color: rgb(105, 138, 147);")
        self.remember_me.setObjectName("remember_me")
        self.gridLayout_2.addWidget(self.remember_me, 2, 0, 1, 1)
    ...
    def retranslateUi(self, login):
        ...
        self.label.setText(_translate("login", "<html><head/><body><p><span style=\" color:#005e87;\">OPUS Login Daten</span></p></body></html>"))
        self.passlabel.setText(_translate("login", "<html><head/><body><p><span style=\" color:#698a93;\">Passwort:</span></p></body></html>"))
        self.userlabel.setText(_translate("login", "<html><head/><body><p><span style=\" color:#698a93;\">Benutzername:</span></p></body></html>"))
        self.remember_me.setText(_translate("login", "Remember me"))
